...
Production 目前係 Render 上單一 Uvicorn process。多人 Live room、部分短期 cache／session／lock 係 process-local memory；未完成 roadmap gate 前唔可以假設 multi-worker／multi-instance 安全。
...
| 未完成工作及 rollout gates | `docs/ROADMAP.md` |
