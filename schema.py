...
TABLE_HISTORY_EVENT_VIDEOS = "history_event_videos"
...
CREATE_HISTORY_EVENT_VIDEOS = f"""
CREATE TABLE IF NOT EXISTS {TABLE_HISTORY_EVENT_VIDEOS} (
...
REVOKE ALL PRIVILEGES ON TABLE
    ...
    {TABLE_HISTORY_EVENT_VIDEOS}, {TABLE_HISTORY_EVENT_PHOTOS},
...
CREATE TABLE IF NOT EXISTS {TABLE_AI_FUND_USAGE_LOGS} (
    ...
    feature             TEXT        NOT NULL
                                CHECK (feature IN ('speech_review', 'strategy', 'competition_prep', 'web_research', 'fact_check', 'free_debate_live', 'full_mock_live', 'vote_review', 'vote_analysis', 'vote_discussion', 'tts_review', 'tts_script_analysis', 'llm_review', 'kiosk_match_review', 'tts', 'kiosk_match_review_tts', 'official_ai_judge', 'lmc_ai_chat', 'lmc_ai_eval')),
    model_label         TEXT        NOT NULL,
    provider            TEXT,
...
CREATE INDEX IF NOT EXISTS idx_history_event_videos_video
    ON {TABLE_HISTORY_EVENT_VIDEOS}(video_id);
...
ALL_SCHEMAS = [
    ...
    CREATE_HISTORY_EVENT_VIDEOS,      # → history_events, match_videos
