...
LMC_AI_NODE_MAX = _limit("LMC_AI_NODE_MAX", 1, minimum=1, maximum=1, group="ai", description="Single enabled outbound AI Workstation")
...
LMC_AI_ACTIVE_GENERATIONS = _limit("LMC_AI_ACTIVE_GENERATIONS", 1, minimum=1, maximum=1, group="ai", description="Concurrent local AI generations on the single Workstation")
...
WORKSTATION_REMOTE_AUDIT_MAX_ENTRIES = _limit("WORKSTATION_REMOTE_AUDIT_MAX_ENTRIES", 200, minimum=50, maximum=1_000, group="runtime", description="Maximum content-free Workstation remote-control audit entries")
WORKSTATION_ASR_PREWARM_TTL_SECONDS = _limit("WORKSTATION_ASR_PREWARM_TTL_SECONDS", 240, minimum=60, maximum=600, group="ai", description="Maximum idle lifetime of a prewarmed ASR worker")
