...
SQL_RESULT_MAX_BYTES = _limit("SQL_RESULT_MAX_BYTES", MIB, minimum=KIB, maximum=MIB, group="api", description="SQL-console serialized bytes")
SQL_RESULT_MAX_CELL_CHARS = _limit("SQL_RESULT_MAX_CELL_CHARS", 10_000, minimum=128, maximum=10_000, group="api", description="SQL-console characters per cell")
SQL_STATEMENT_TIMEOUT_MS = _limit("SQL_STATEMENT_TIMEOUT_MS", 10_000, minimum=1_000, maximum=60_000, group="api", description="SQL-console statement timeout")
