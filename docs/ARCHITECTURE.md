...
Audit起始時production有41張public tables；2026-07-13完成typed config預遷移後新增`app_config`，現為42張。`schema.py`仍包含若干尚未建立的下一階段AI/resource tables；因此不可再把bootstrap DDL當作production truth。
...
- 同日production catalog checksum為`18b2734a1abea3dfca2afb7e0f9678ef01e7d4d6fa99ffa2f3b5e1d5d235bffb`（PostgreSQL 17.6；42 tables／321 columns／119 constraints／78 indexes／0 RLS policies）。Checksum只計schema定義，不計浮動row/size metrics。
