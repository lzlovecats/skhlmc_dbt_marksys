...
| Mode A真人聯機完場AI評判 | `deploy/proxy.py`, `frontend/shared/room-debate-p2p.js` | Browser逐字稿完整時，依次 Gemini 3.5 Flash → Gemini 2.5 Flash → Gemini 2.5 Flash Lite；P2P音訊不送provider | `AI_FEATURE_MODEL_FALLBACK_LABELS["room_judgement"]` |
